...
namespace Recruitment_App.Repo.Migrations
{
    ...
    [Migration("20221223092932_addrelation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicantJobTitle", b =>
                {
                    ...
                    b.HasKey("ApplicantsId", "JobTitlesId");

                    b.HasIndex("JobTitlesId");

                    b.ToTable("ApplicantJobTitle");
                });

            modelBuilder.Entity("JobTitleSkill", b =>
                {
                    b.Property<Guid>("JobTitlesId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApplicantJobTitle", b =>
                {
                    b.HasOne("Recruitment_App.Repo.Entities.Applicant", null)
                        .WithMany()
                        .HasForeignKey("ApplicantsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Recruitment_App.Repo.Entities.JobTitle", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JobTitleSkill", b =>
                {
                    ...
                    b.HasOne("Recruitment_App.Repo.Entities.Skill", null)
                        .WithMany()
